...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "ওই কিরে") || (event.body.toLowerCase() == "oi keray") ||(event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...")) {
     return api.sendMessage("⎯͢⎯⃝💙😒বেশি বকবক করলে চুম্মা💋🥵দিয়ে অজ্ঞান করে দিব_😹🤣🐸😹⎯͢⎯⃝💙", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🫦") || (event.body.toLowerCase() == "💋")) {
     return api.sendMessage("⎯͢⎯⃝💙কি্ঁস্ঁ💋🥵দি্ঁবো্ঁ ভি্ঁজে্ঁ💦গে্ঁলে্ঁ দো্ঁষ্ঁ না্ঁই্ঁ😒🐸😹⎯͢⎯⃝💙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "opu") || (event.body.toLowerCase() == "Ullash bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ opu ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 opu.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/share/1B8APYJFZH/\nতার সাতে যোগা যোগ করবেন WhatsApp :- +351 960 215 605", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is opu ッ❤️ তাকে সবাই অপু নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "চলো যাই") || (event.body.toLowerCase() == "@Farhana Ontora ")) {
     return api.sendMessage("️Xan's🫦🍓____চলো জান দেখা করে কট খাইই-!/-👅🥵💦", threadID);
   };

  if ((event.body.toLowerCase() == "তারন্যা") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("⎯͢⎯⃝💙😒তারন্যা কে কেউ ডাক দিবি না বেশি😤সে এসে দেখলে।👀কিন্তু তদের লাথি🦶মেরে ভবিষ্যত অন্ধকার করে দিব 😒_😹🤣🐸😹⎯͢⎯⃝💙", threadID);
   };
  
  if ((event.body.toLowerCase() == "আঁখি") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("⎯͢⎯⃝💙😒আঁখি কে কেউ ডাক দিবি না বেশি😤সে এসে দেখলে।👀কিন্তু তদের লাথি🦶মেরে ভবিষ্যত অন্ধকার করে দিব 😒_😹🤣🐸😹⎯͢⎯⃝💙", threadID);
   };

  if ((event.body.toLowerCase() == "নডিরা ভালোহ") || (event.body.toLowerCase() == "farhana")) {
     return api.sendMessage("/✨🙊💦🙂🐸😩____ভালো হতে গিয়ে আরো খান'কি মা'গি হয়ে গেছি..........!🥵🔥🤦🏻‍♀️••••••••••🐰🌼", threadID);
   };

  if ((event.body.toLowerCase() == "লাইফ ") || (event.body.toLowerCase() == "সিয়াম")) {
     return api.sendMessage("তো্ঁমা্ঁকে্ঁ⎯͢পে্ঁয়ে্ঁ⎯সি্ৃঙ্গে্ঁল্ঁ লা্ঁই্ঁফ্ঁ প্ঁদ্ঁত্যা্ঁগ্ঁ ক্ঁর্ঁতে্ঁ চা্ঁই্ঁ বাৃ্ঁবুৃ্ঁরৃ্ঁ আৃ্ঁব্বুৃ্ঁ তাৃ্ঁহ্ঁ ✮⃝😍💦🍒🤌", threadID);
   };

   if ((event.body.toLowerCase() == "🥵") || (event.body.toLowerCase() == "kiss me")) {
     return api.sendMessage("️ ⎯͢⎯⃝💙😒বেশি বকবক করলে চুম্মা💋🥵দিয়ে অজ্ঞান করে দিব_😹🤣🐸😹⎯͢⎯⃝💙", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️♡⎯͢⎯⃝🐰প্ঁটে্ঁ জা্ঁও্ গৃ্ঁরৃ্ঁমেৃ্ঁ বা্ঁতা্ঁস্ঁ কৃ্ঁরে্ঁ দি্ঁবো্ঁ🌺🫰 ⃝🦋🌺🐸😫", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Pic de") || (event.body.toLowerCase() == "দিব")) {
     return api.sendMessage("️🦶লাথি দিয়ে নেটওয়ার্ক এর বাহিরে ফেলে দিব 😹", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😅") || (event.body.toLowerCase() == "...")) {
     return api.sendMessage("️️⎯͢⎯⃝💙😒মেয়েরা আল্লার পথে আয় ছেলেরা আমার ইনবক্সে আয় 😒_😹🤣🐸😹⎯͢⎯⃝💙", threadID);
   };
